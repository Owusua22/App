...
// Spacing (match other category screens)
const SPACING = {
  xs: 4,
  sm: 8,
  md: 12,
...
const AirConditionScreen = () => {
      ...
      const checkScrollRestore = async () => {
        try {
          const saved = await AsyncStorage.getItem(
            "AirConditionScreenScrollPosition"
          );
          if (saved) {
  ...
  // Restore scroll once products ready
  useEffect(() => {
  ...
  const handleShare = async () => {
    try {
      await Share.share({
        message:
          "Cool your space with these great air conditioners from Franko Trading!",
  ...
  if (productsLoading) {
    return (
      <View style={styles.loaderContainer}>
        ...
        <Text style={styles.loaderText}>Loading air conditioners...</Text>
      </View>
    );
  }
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Air Conditioners</Text>
