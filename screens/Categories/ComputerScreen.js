...
const ComputerScreen = () => {
  ...
  // Add to cart per‑product loading
  ...
  // scroll restore when list ready
  useEffect(() => {
  ...
  const handleShare = async () => {
    try {
      await Share.share({
        message:
          "Check out these laptops & computers at great prices on Franko Trading!",
  ...
  if (productsLoading) {
    return (
      <View style={styles.loaderContainer}>
        ...
        <Text style={styles.loaderText}>Loading laptops...</Text>
      </View>
    );
  }
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Laptops & Computers</Text>
