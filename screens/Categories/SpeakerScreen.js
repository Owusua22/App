...
const SpeakerScreen = () => {
  ...
  /* ---------- scroll restoration when list ready ---------- */
  ...
  const handleShare = async () => {
    try {
      await Share.share({
        message:
          "Turn up the volume with these amazing speakers from Franko Trading!",
        title: "Speakers",
      });
    } catch {
  ...
  if (productsLoading) {
    return (
      <View style={styles.loaderContainer}>
        ...
        <Text style={styles.loaderText}>Loading speakers...</Text>
      </View>
    );
  }
